        ...
        <div class="flex-container">
            <div class="flex-item-left">
                ...
                <div class="basket-section">
                    <p style="font-weight: 600;">My Basket</p>
                    <?php
            ...
            <div class="flex-item-right">
                <div class="checkout-section">
                    <p style="font-weight: 600; margin-bottom: 2%;">Checkout</p>
                    <ul>
                        <li>
                        ...
                        <?php
                            ...
                            if (isset($_SESSION['totalCost'])) {
                                ?><p><?php echo "Basket Total: £" . number_format($_SESSION['totalCost'], 2);?></p>
                            <?php
                            } else {
                            ...
                            if (isset($_SESSION['totalCost2']) &&(isset($_SESSION['discount']))) {
                                ?>
                                <p><?php echo "Discount Total: £" . number_format($_SESSION['totalCost2'], 2);?></p>
                        ...
                        <li>
                            ...
                            <form method="POST" action="includes/basket-promo.inc.php">
                                <input class="promo" name="code" placeholder="PROMO CODE">
                                <input type="hidden" name="customer_ID" value="<?php echo $row['user_id']; ?>"/>
                                <input type="submit" class="checkoutButton" value="Apply Discount" name="promo"/>
                            </form>
                        </li> 
                        <p style="font-weight: 600; margin: 4% 0;">Delivery Address</p>
                        <form method="POST" action="checkout.php" class="checkout">
                            <li>
                                <div class="delivery-address-flex">
                                    <div class="delivery-address">
                                        <label for="addressline1" style="float:left;"><p>Address line 1 *</p></label>
                                        <input class="delivery" style="padding: 8px; width: 98%;" type="text" name="addressline1" placeholder="Address line 1" required>
                                    </div>
                                    <div class="delivery-address">
                                        <label for="addressline2" style="float:left;"><p>Address line 2</p></label>
                                        <input style="padding: 8px; width: 98%;" type="text" name="addressline2" placeholder="Address line 2">
                                    </div>
                                </div>
                                <label for="town" style="float:left;"><p>Town/City *</p></label>
                                <input style="padding: 8px;" type="text" name="town" placeholder="Town/City" required>
                                <label for="postcode" style="float:left;"><p>Postcode *</p></label>
                                <input style="padding: 8px;" type="text" name="postcode" placeholder="Postcode" required>
...
<footer style="background-color:rgb(240, 240, 240);">
    ...
    <div class="footer">
        ...
        <a href="prints.php"><p>Prints</p></a>
        <a href="greetingCards.php"><p>Greetings Cards</p></a>
