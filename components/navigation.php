...
<nav>
    ...
    <?php 
        ...
        <?php
        include ('classes/basket-nav-count.classes.php');
        $count = new BasketItemCount();
        $basketCount = $count->basketCount($userID);
        ?>
        <div class="basket-section-nav">
            <div class="circle-Basket"><p><?php echo $basketCount ?></p></div>
