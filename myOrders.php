    ...
    <div class="order-content">
        <div class="row-order">
            ...
            foreach ($orders as $row) {
                ...
                $orderItems = $getItems->fetchOrderItems(orderid: $orderid); ?> <!--this gets the items in the order -->
                <div class="column-order">
                    <div class="order-top-box">
                        <p style="color: black; margin:0;"><?php echo htmlspecialchars($row['order_Status']);?></p>
                        <p style="color: black; margin:0;"><?php echo htmlspecialchars($row['order_Date']);?></p>
                    </div>
